...
execute if score start start_timer matches 4 run function abba:main/actionbar
...
execute if score start start_timer matches 4 run scoreboard players set @a leaderboard 0
